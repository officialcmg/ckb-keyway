...
This requirement applies only to `nodeMode="browser"`. Managed mode does not load Fiber WASM in the consuming page, but it currently requires explicit testnet beta enrollment.
